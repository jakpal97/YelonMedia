...
const categoryData = {
	...
	eventy: {
		...
		images: [
			...
			{
				id: 5,
				src: 'https://yelonmedia.s3.us-east-1.amazonaws.com/Eventy/DSC02198.jpg',
				title: 'Konferencja branżowa',
				alt: 'Zdjęcie z konferencji',
				description: 'Międzynarodowa konferencja biznesowa',
			},
			{
				id: 6,
				src: 'https://yelonmedia.s3.us-east-1.amazonaws.com/Eventy/DSC09818.jpg',
				title: 'Konferencja branżowa',
				alt: 'Zdjęcie z konferencji',
				description: 'Międzynarodowa konferencja biznesowa',
			},
			{
				id: 7,
				src: 'https://yelonmedia.s3.us-east-1.amazonaws.com/Eventy/DSC02380.jpg',
				title: 'Konferencja branżowa',
				alt: 'Zdjęcie z konferencji',
				description: 'Międzynarodowa konferencja biznesowa',
			},
	...
	motoryzacja: {
		...
		images: [
			...
			{
				id: 5,
				src: 'https://yelonmedia.s3.us-east-1.amazonaws.com/Motoryzacja/DSC01820.jpg',
				title: 'Sportowy sedan',
				alt: 'Zdjęcie sportowego sedana',
				description: 'Luksusowy sportowy sedan',
			},
