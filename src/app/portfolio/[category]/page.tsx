...
const categoryData = {
	uslugi: {
		...
		images: [
			...
			{
				id: 11,
				src: 'https://yelonmedia.s3.us-east-1.amazonaws.com/Salony+Fryzjerskie/DSC06714-2.jpg',
				title: 'Sztuka tatuażu',
				alt: 'Zdjęcie sztuki tatuażu',
				description: 'Artystyczne ujęcie tatuażu',
			},
			{
				id: 12,
				src: 'https://yelonmedia.s3.us-east-1.amazonaws.com/Salony+Fryzjerskie/DSC06743-2.jpg',
				title: 'Sztuka tatuażu',
				alt: 'Zdjęcie sztuki tatuażu',
				description: 'Artystyczne ujęcie tatuażu',
			},
			{
				id: 13,
				src: 'https://yelonmedia.s3.us-east-1.amazonaws.com/Salony+Fryzjerskie/DSC06617-2.jpg',
				title: 'Sztuka tatuażu',
				alt: 'Zdjęcie sztuki tatuażu',
				description: 'Artystyczne ujęcie tatuażu',
			},
	...
	gastro: {
		...
		heroImage: 'https://yelonmedia.s3.us-east-1.amazonaws.com/Gastro/2.jpg',
