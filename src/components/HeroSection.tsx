				...
				<div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center min-h-[80vh]">
					...
					<div className="space-y-8 text-center lg:text-left">
						<div className="space-y-2">
							<h1 className="sr-only">Profesjonalny fotograf w Tarnowskich Górach - Yelon Media</h1>
							<div
								...
								style={{ transitionDelay: '0ms', fontWeight: 700 }}>
								Uwieczniam
							</div>
							<div
								className={`text-4xl md:text-5xl lg:text-6xl font-savate font-bold leading-tight block transition-all duration-1000 ${
								...
								style={{ transitionDelay: '200ms', fontWeight: 700 }}>
								Najważniejsze
							</div>
							<div
								className={`text-4xl md:text-5xl lg:text-6xl font-savate font-bold leading-tight block transition-all duration-1000 ${
								...
								style={{ transitionDelay: '400ms', fontWeight: 700 }}>
								Chwile
							</div>
						</div>
						...
						<p
							...
							Profesjonalny fotograf w Tarnowskich Górach i na Śląsku. Kreatywna fotografia i film - sesje ślubne,
							portretowe i eventowe. Pomogę Ci poprawić wizerunek Twojej firmy w social mediach.
						</p>
